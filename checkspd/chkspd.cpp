...
int main( int argc, char **argv ) {
    ...
    printf( "Relative: 060/50Mhz Amiga OS MDEV4 |GNU-C |   %7.2f [ir]   %7.2f [fr]\n", rel1, rel2 );

    rel1 = mips / 82.5;
    rel2 = mflops / 15.7;

    printf( "Relative: 060/50Mhz       Amiga OS |GNU-C |   %7.2f [ir]   %7.2f [fr]\n", rel1, rel2 );
    ...
    printf( "Relative: Intel N5105     Linux OS |GCC13.3|  %7.2f [ir]   %7.2f [fr]\n", rel1, rel2 );

    rel1 = mips / 2352.2;
    rel2 = mflops / 1018.6;

    printf( "Relative: Intel N4000     Linux OS |GCC13.3|  %7.2f [ir]   %7.2f [fr]\n", rel1, rel2 );
